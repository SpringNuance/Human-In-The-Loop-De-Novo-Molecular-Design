...
def do_run(
    ...
    train_sample = train_set[train_set["activity"] == 1].sample(30).smiles.tolist()
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 10:
        ...
        do_run(seed, dirname, init_model_path, init_train_set, model_type, K, opt_steps, train_similarity, pretrained_prior, acquisition, sigma_noise, T, n_queries, benchmark, threshold)
    else:
