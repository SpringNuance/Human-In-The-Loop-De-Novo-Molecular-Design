...
def write_REINVENT_config_rank_listnet(reinvent_dir, jobid, jobname, output_dir, conf_filename):
    ...
    human_component = {
        ...
        "specific_parameters": {
            ...
            "model_definition_path": "/home/springnuance/reinvent-hitl/Base-Code-Binh/training_Rank_ListNet_model/rank_listnet.py",
            "model_name": "rank_listnet",
            "rank_listnet": "classification",
            "descriptor_type": "ecfp",
            "size": 2048,
            "container_type": "rank_listnet_container",
            "use_counts": True,
            "use_features": True,
            "transformation": {
