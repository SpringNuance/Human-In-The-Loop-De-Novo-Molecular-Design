...
def create_drd2_dataset(feedback_type, new_queried_smiles, 
    ...
    if feedback_type == "scoring":
        ...
        num_comb = len(comb)  # This is the number of combinations, which is binom(num_new_queried_smiles, 3)

        smiles_1 = []
        smiles_2 = []
        smiles_3 = []
        
        features_1 = np.zeros((num_comb, fps_dim))
        features_2 = np.zeros((num_comb, fps_dim))
        features_3 = np.zeros((num_comb, fps_dim))
